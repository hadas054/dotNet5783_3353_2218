                        ...
                        case 1:
                            ...
                            switch (chooseMenu)
                            {
                                ...
                                case 2:
                                    ...
                                    Console.WriteLine(Dal.DalProduct.Get(id1));
                                    break;
                                case 3:
                                    Product[] prod = DalProduct.allProducts();
                                ...
                                case 4:
                                    ...
                                    p1.inStock = stock1;
                                    if (p1.Name.Length > 0)
                                        Dal.DalProduct.Update(p1);
                                    break;
                                case 5:
                                    int id3;
                                    Console.WriteLine("enter id of product");
                                    int.TryParse(Console.ReadLine(), out id3);
                                    Dal.DalProduct.Delete(id3);
                                    break;
                            }
                            break;
                        case 2:
                            ...
                            switch (chooseMenu)
                            {
                                ...
                                case 2:
                                    ...
                                    int.TryParse(Console.ReadLine(), out id);
                                    Console.WriteLine(Dal.DalOrder.Get(id));
                                    break;
                                case 3:
                                    Order[] ord = DalOrder.allOrders();
                                ...
                                case 4:
                                    ...
                                    if (order1.CustomerName.Length > 0)
                                        Dal.DalOrder.Update(order1);
                                    break;
                                case 5:
                                    Console.WriteLine("enter id of order");
                                    int.TryParse(Console.ReadLine(), out id);
                                    Dal.DalOrder.Delete(id);
                                    break;
                            }
                            break;
                        case 3:
